import scrollListener from './scroll_listener';

export default class {
  constructor(elements, eventLabel) {

    console.log(scrollListener.init(this.testing.bind(this)));
  ...
  scroll() {
    ...
    for (let i = elements.length; i--; ) {
      ...
      if (
        elements[i].top < scrollBottom &&
        elements[i].bottom > this.scrollTop
      ) {
        ...
        this.elements[elements[i].index].dispatchEvent(
